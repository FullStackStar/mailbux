...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div>
            <a href="{{$base_url}}/super-admin/subscription-plan" class="btn btn-primary">{{__('New Subscription Plan')}}</a>
        </div>
    </div>
                        ...
                        <div class="text-center">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="{{$base_url}}/super-admin/subscription-plan?uuid={{$subscription_plan->uuid}}">{{__('Edit')}}</a></li>
                                    <li><a class="dropdown-item" data-delete-item="true" href="{{$base_url}}/super-admin/delete/subscription-plan/{{$subscription_plan->uuid}}">{{__('Delete')}}</a></li>
                                </ul>
                            </div>
                        </div>
