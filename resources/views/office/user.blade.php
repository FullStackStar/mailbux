        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-body">
                    ...
                    <form novalidate="novalidate" method="post" action="{{route('office.save-user')}}" id="form-user" data-form="{{$base_url}}/office/settings?tab=users" data-btn-id="btn-save-user">
